...
namespace Persistence.Monsters
{
    public class Noob : Monster
    {
        ...
        //private List<Direction> _path = new List<Direction>();
        ...
        //public List<Direction> Path { get { return _path; } private set { _path = value; } }

        public Noob(int id, Point coord) : base(id, coord) 
        {
